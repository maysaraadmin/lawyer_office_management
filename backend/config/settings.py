...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'lawyer_office'),
...
# Only include the static directory if it exists
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@lawyeroffice.com')
